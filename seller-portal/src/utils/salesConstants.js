 ...
 * on the sales list, the entry form, the ledger and the reports page.
 *
 * `WEB` means the *external* selling platform — this system has no storefront of
 * its own. Sales made there are recorded here like any other channel. The `id`
...
export const SALE_CHANNELS = [
  ...
  { id: 'WEB', label: 'Tienda en línea (externa)', icon: 'language' },
